...
productRouter.get("/seller/mine", authenticate, requireRole("SELLER", "ADMIN"), ah(products.sellerProducts));
...
productRouter.post("/", authenticate, requireRole("SELLER", "ADMIN"), validate(products.productSchema), ah(products.createProduct));
productRouter.put("/:id", authenticate, requireRole("SELLER", "ADMIN"), ah(products.updateProduct));
productRouter.delete("/:id", authenticate, requireRole("SELLER", "ADMIN"), ah(products.deleteProduct));
